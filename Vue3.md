...
-   [Usage alongside normal ](https://vuejs.org/api/sfc-script-setup.html#usage-alongside-normal-script)
...
-   [PropType](https://vuejs.org/api/utility-types.html#proptype-t)
